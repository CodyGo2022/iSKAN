    ...
    <main class="my-profile-content">
        <nav class="navbar fixed-bottom second-bg">
            <div class="container d-flex justify-content-around">
                ...
                <a href="my_store.php" class="navbar-brand d-flex flex-column mx-0 px-2 align-items-center main-text-color active-icon">
        ...
        <section class="d-flex flex-column main-text-color">
            <div class="create-store-header">
                <div class="px-4">
                    <div class="d-flex justify-content-between">
                        <h6 class="fw-bold mb-0 fourth-text-color">Creating your Store</h6>
            ...
            <div class="d-flex align-item-start card px-4 py-4" style="margin-bottom: 220px">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPhonenumber" placeholder="Phone number">
                    <label for="floatingPhonenumber">Business Name</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPhonenumber" placeholder="Phone number">
                    <label for="floatingPhonenumber">Type of Business</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPhonenumber" placeholder="Phone number">
                    <label for="floatingPhonenumber">Location</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPhonenumber" placeholder="Phone number">
                    <label for="floatingPhonenumber">Business PIN</label>
                </div>
            </div>
            <div class="d-flex align-items-end pb-5 h-100 px-4">
                <a href="my_menu.php" type="button" class="main-color w-100 mt-5 py-2 rounded-3 text-center">Next</a>
            </div>
        </section>
    </main>
