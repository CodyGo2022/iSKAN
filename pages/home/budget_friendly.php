...
<body>
    <main class="budget-friendly-content">
        <nav class="navbar fixed-bottom second-bg">
            <div class="container d-flex justify-content-around">
                <a href="budget_friendly.php" class="navbar-brand d-flex flex-column mx-0 px-2 align-items-center main-text-color active-icon">
            ...
            <div class="pt-4">
                ...
                <section class="budget-friendly">
                    <div class="d-flex justify-content-between">
                        <h6 class="fw-bold mb-3">Budget Friendly</h6>
